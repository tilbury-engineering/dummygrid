...
const manufacturers = [
 ...
 {id:"kosmic",name:"Kosmic Kart",group:"OTK Kart Group",country:"Italy",founded:"1996",site:"https://www.kosmickart.com/",aliases:["Kosmic"],history:"Kosmic is an OTK Kart Group brand focused on international racing chassis and competition programmes.",products:["Mercury RR","Mini","KZ / gearbox chassis","OTK Kart Parts","OTK Kart Wear / racewear and clothing"],newsTerms:["kosmic kart","kosmic"]},
 {id:"exprit",name:"Exprit",group:"OTK Kart Group",country:"Italy",founded:"2005",site:"https://www.expritkart.com/",aliases:["Exprit"],history:"Exprit is part of OTK Kart Group and competes across major international karting categories.",products:["Noesis T","TDX","Rookie","KZ / gearbox chassis","OTK Kart Parts","OTK Kart Wear / racewear and clothing"],newsTerms:["exprit"]},
 {id:"ln-racing-kart",name:"LN Racing Kart",group:"OTK Kart Group",country:"Italy",founded:"2021",site:"https://www.lnracingkart.com/",aliases:["LN Racing Kart","LN Kart"],history:"LN Racing Kart is the OTK-linked chassis brand created around Fernando Alonso's LN identity.",products:["LN Four","Mini","KZ / gearbox chassis","Frames and components","OTK Kart Parts","OTK Kart Wear / racewear and clothing"],newsTerms:["ln racing kart","ln kart"]},
 ...
 {id:"birel-art",name:"Birel ART",group:"Korus Group",country:"Italy",founded:"1959",site:"https://www.birelart.com/",aliases:["Birel","Birel ART"],history:"Birel traces its roots to Umberto Sala's first karts in the late 1950s. Birel ART was formed through the later partnership with ART Grand Prix.",products:[{name:"KZ S19 chassis",type:"KZ / shifter chassis",image:"https://www.birelart.com/public/karts/modelli/IMG_4430-frontale.jpg"},{name:"OK S19 chassis",type:"OK / direct-drive chassis",image:"https://www.birelart.com/public/karts/modelli/IMG_4430-frontale.jpg"},{name:"Mini S19 chassis",type:"Mini chassis",image:"https://www.birelart.com/public/karts/modelli/IMG_4430-frontale.jpg"},{name:"Baby S19 chassis",type:"Baby chassis",image:"https://www.birelart.com/public/karts/modelli/IMG_4430-frontale.jpg"},{name:"ROTAX DD2 S19 chassis",type:"Rotax DD2 chassis",image:"https://www.birelart.com/public/karts/modelli/IMG_4430-frontale.jpg"},{name:"Freeline accessories and chassis components",type:"Components and accessories"},{name:"Birel ART sportswear",type:"Race suit, winter jacket, soft-shell jacket, sweatshirt, polo, T-shirt, padded vest, rain jacket, trousers, shorts, hat and apron"}],newsTerms:["birel art","birelart","birel"]},
 ...
 {id:"sodikart",name:"Sodikart",group:"Sodikart",country:"France",founded:"1981",site:"https://www.sodikart.com/",logo:"https://tkart.it/uploads/2024/12/logo-card-tavola-disegno-1-10.jpg",aliases:["Sodi","Sodikart"],history:"Sodikart is a French manufacturer with more than four decades in karting, producing both racing and rental karts from its French factory. Its business also includes karting equipment, accessories, specialist tools, retail and race-event activity.",products:[{name:"Furia 950 (2026)",type:"Minime / Cadet racing chassis",image:"https://www.sodikart.com/content/images/karts/37/main/1-kart-1773239859.png"},{name:"Sigma RS3 (2026)",type:"Senior direct-drive racing chassis"},{name:"Sigma DD2 (2026)",type:"Rotax DD2 racing chassis"},{name:"Sigma KZ (2026)",type:"KZ / gearbox racing chassis"},{name:"NOVA",type:"Rental kart range: SR6, LRX2, LR6, RT10, RSX2, Sport, KidRacer, SR4, SR5, 2Drive and X2Drive"},{name:"BOX’S equipment",type:"Race suits, gloves, shoes, helmets and driver equipment"},{name:"TEKNEEX components",type:"Stubs, hubs, axles, sprocket carriers, brake systems and seats"},{name:"MEKAONE tools",type:"Gauges, trolleys, clutch tools and tyre equipment"}],newsTerms:["sodikart","sodi kart","sodi racing"]},
 ...
 {id:"formula-k",name:"Formula K",group:"IPK",country:"Italy / Czech Republic",founded:"2000s",site:"https://www.ipkarting.com/",aliases:["Formula K"],history:"Formula K is one of the racing chassis marques within the IPK portfolio.",products:["Speedy 02 Mini 2026","Cruiser MS3 KZ 2026","Explorer KZ 2026","Matrix KZ 2026","Escape 2026 OK/JR","Freedom F4K 4-stroke","Scout Baby Kart","Falcon DD2","Aluminium and magnesium configurations","Frames","Bodywork and supports","Brake systems","Wheels and hubs","Seats","Steering systems","Pedals","Exhaust supports","Engine mounts","Fuel tanks","Radiators and cooling","Air filters","Transmission and chains","Torsion bars","Cables and fasteners","Trolleys","Intrepid / Sparco race suits"],newsTerms:["formula k kart"]},
 ...
 {id:"intrepid",name:"Intrepid Driver Program",group:"Intrepid Driver Program SRL",country:"Italy",founded:"2000s",site:"https://www.intrepid-kart.com/en",aliases:["Intrepid"],history:"Intrepid has competed internationally as a chassis and racing brand across multiple karting categories.",products:["Speedy 02 Mini 2026","Cruiser MS3 KZ 2026","Explorer KZ 2026","Matrix KZ 2026","Escape 2026 OK/JR","Freedom F4K 4-stroke","Scout Baby Kart","Falcon DD2","Aluminium and magnesium configurations","Frames","Bodywork and supports","Brake systems","Wheels and hubs","Seats","Steering systems","Pedals","Exhaust supports","Engine mounts","Fuel tanks","Radiators and cooling","Air filters","Transmission and chains","Torsion bars","Cables and fasteners","Trolleys","Intrepid / Sparco race suits"],newsTerms:["intrepid kart"]},
...
function ProductImage({m,p}){
 const [failed,setFailed]=useState(false);
 const src=p.image;
 return <div className="product-image">{src&&!failed?<img src={src} alt={p.name+" - "+m.name} onError={()=>setFailed(true)}/>:<ManufacturerLogo m={m} className="product-logo-fallback"/>}</div>
}
...
function ManufacturerDetail({id}){
 ...
 <div className="product-catalogue">{products.map(p=><div className="product-card" key={p.name}><ProductImage m={m} p={p}/><div><h3>{p.name}</h3><p>{p.type||"Karting product"}</p>{p.className&&<Pill>{p.className}</Pill>}</div></div>)}</div>
