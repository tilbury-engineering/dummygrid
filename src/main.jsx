...
function FIAProfile(){
 return <section>
  ...
  <SectionHead eyebrow="Leadership" title="Key people" copy="Senior FIA figures and karting leadership relevant to the sport."/>
  <div className="people-grid">
   <article className="panel"><div className="meta">FIA PRESIDENT</div><h3>Mohammed Ben Sulayem</h3><p>President of the Fédération Internationale de l’Automobile.</p></article>
   <article className="panel"><div className="meta">FIA SECRETARY GENERAL FOR SPORT</div><h3>Valerio Iachizzi</h3><p>Senior executive responsible for the FIA sporting organisation.</p></article>
   <article className="panel"><div className="meta">FIA KARTING COMMISSION PRESIDENT</div><h3>Akbar Ebrahim</h3><p>President of the FIA Karting Commission and a leading figure in the FIA Global Karting Plan.</p></article>
   <article className="panel"><div className="meta">FIA KARTING GENERAL MANAGER</div><h3>Alberto Villarreal</h3><p>General Manager for FIA Karting.</p></article>
  </div>
...
function CIKProfile(){
 return <section>
  ...
  <SectionHead eyebrow="Leadership" title="Karting leadership" copy="The senior people currently identified by FIA sources for FIA Karting."/>
  <div className="people-grid"><article className="panel"><div className="meta">FIA KARTING COMMISSION PRESIDENT</div><h3>Akbar Ebrahim</h3><p>President of the FIA Karting Commission.</p></article><article className="panel"><div className="meta">FIA KARTING GENERAL MANAGER</div><h3>Alberto Villarreal</h3><p>General Manager for FIA Karting.</p></article></div>
