...
function App(){
 ...
 return <><Top region={region} setRegion={setRegion}/><main>{page}</main><footer><a className="logo footer-logo" href="#/" aria-label="DummyGrid home"><img src={DUMMYGRID_LOGO} alt="DummyGrid"/></a><p>The world of karting, local to you.</p><div><a href="#/news">News</a><a href="#/marketplace">Marketplace</a><a href="#/drivers">Drivers</a><a href="#/classes">Classes</a><a href="#/manufacturers">Manufacturers</a><a href="#/asns">ASNs</a><a href="#/results">Results</a><a href="#/tracks">Tracks</a><a href="#/advertise">Advertise</a></div></footer></>
}
