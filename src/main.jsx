...
function HallOfFame(){
 ...
 <HallOfFameFeatured/>
 <div className="hof-pioneer-row"><a className="hof-feature-card" href="#/hall-of-fame/driver/Art%20Ingels"><div className="pioneer-banner">PIONEER</div><DriverPortrait name="Art Ingels"/><div className="hof-feature-copy"><div className="meta">FOUNDERS & PIONEERS</div><h2>Art Ingels</h2><strong>THE FOUNDING FATHER</strong><p>Widely recognised as the father of karting and builder of the first go-kart in 1956.</p><span>View profile →</span></div></a><a className="hof-feature-card" href="#/hall-of-fame/driver/Martin%20Hines"><div className="pioneer-banner">PIONEER</div><DriverPortrait name="Martin Hines"/><div className="hof-feature-copy"><div className="meta">HALL OF FAME · SUPERKART</div><h2>Martin Hines</h2><strong>MR KARTING</strong><p>Three-time World Champion, Zip Kart pioneer and one of the most influential figures in the development of modern karting.</p><span>View profile →</span></div></a><a className="hof-feature-card" href="#/hall-of-fame/pioneer/Duffy%20Livingston"><div className="pioneer-banner">PIONEER</div><DriverPortrait name="Duffy Livingston"/><div className="hof-feature-copy"><div className="meta">FOUNDING PIONEER</div><h2>Duffy Livingston</h2><strong>EARLY KARTING</strong><p>Co-founder of Go-Kart Manufacturing and a central figure in the birth of organised kart racing.</p><span>View profile →</span></div></a><a className="hof-feature-card" href="#/hall-of-fame/pioneer/Roy%20Desbrow"><div className="pioneer-banner">PIONEER</div><DriverPortrait name="Roy Desbrow"/><div className="hof-feature-copy"><div className="meta">FOUNDING PIONEER</div><h2>Roy Desbrow</h2><strong>EARLY KARTING</strong><p>Early kart builder and co-founder of Go-Kart Manufacturing alongside Duffy Livingston.</p><span>View profile →</span></div></a><a className="hof-feature-card" href="#/hall-of-fame/pioneer/Lou%20Borelli"><div className="pioneer-banner">PIONEER</div><DriverPortrait name="Lou Borelli"/><div className="hof-feature-copy"><div className="meta">FOUNDING PIONEER</div><h2>Lou Borelli</h2><strong>EARLY KARTING</strong><p>Early builder and organiser who helped establish commercial and competitive karting.</p><span>View profile →</span></div></a><a className="hof-feature-card" href="#/hall-of-fame/pioneer/Angelo%20Parrilla"><div className="pioneer-banner">PIONEER</div><DriverPortrait name="Angelo Parrilla"/><div className="hof-feature-copy"><div className="meta">FOUNDING PIONEER</div><h2>Angelo Parrilla</h2><strong>DAP · INTERNATIONAL KARTING</strong><p>Co-founder of DAP and one of the key figures in the development of modern international karting.</p><span>View profile →</span></div></a></div><div className="hof-intro"><div><b>FROM THE GRID TO THE WORLD</b><p>Karting has been the starting point for generations of elite drivers. KartGrid traces the drivers who converted that foundation into recognised championship success at international level.</p></div><div className="hof-stat"><strong>{[...hallOfFame,...additionalHall].filter((d,i,a)=>a.findIndex(x=>x.name===d.name)===i).length}</strong><span>featured drivers</span></div></div>
